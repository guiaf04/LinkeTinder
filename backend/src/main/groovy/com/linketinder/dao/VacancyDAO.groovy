...
class VacancyDAO{
    ...
    String getElementByIdEmpresaAndName(Vaga vaga) {
        ...
        String query = "SELECT * FROM vaga " +
                "WHERE firstName='${vaga.getNome()}' AND id_empresa='${vaga.getIdempresa()}'"
    ...
    boolean criar(Vaga vaga) {
        ...
        String query = "INSERT INTO vaga " +
                "(firstName, descricao, local, id_empresa) " +
    ...
    boolean atualizar(Vaga vaga) {
        ...
        String setClause = "firstName='${vaga.getNome()}', descricao='${vaga.getDescricao()}'" +
                ", local='${vaga.getLocal()}', id_empresa='${vaga.getIdempresa()}'"

        String query = "UPDATE vaga SET ${setClause} WHERE id_empresa='${vaga.getIdempresa()} AND firstName='${vaga.getIdempresa()}'"
    ...
    boolean deletar(Vaga vaga) {
        ...
        String query = "DELETE FROM vaga WHERE id_empresa='${vaga.getIdempresa()}' AND firstName='${vaga.getNome()}'"
