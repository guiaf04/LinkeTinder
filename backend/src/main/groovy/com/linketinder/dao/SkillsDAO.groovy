...
class SkillsDAO{
    ...
    boolean criar(Competencia competencia) {
        ...
        String query = "INSERT INTO competencia " +
                "(firstName) VALUES ('${competencia.getNome()}')"
    ...
    String getElementByName(Competencia competencia){
        ...
        String query = "SELECT * FROM " +
                "competencia " +
                "WHERE firstName='${competencia.getNome()}'"
    ...
    boolean atualizar(Competencia competencia) {
        ...
        String setClause = "firstName='${competencia.getNome()}'"

        String query = "UPDATE competencia SET ${setClause} WHERE firstName='${competencia.getNome()}'"
    ...
    boolean deletar(Competencia competencia) {
        ...
        String query = "DELETE FROM competencia WHERE firstName='${competencia.getNome()}'"
